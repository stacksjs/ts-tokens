...
import type { Point, XYSize } from '../../../type-definitions/quagga.d'
import type { EventHandlerList, InputStream, InputStreamFactory } from './input_stream'
