...
<template>
  <div style="padding: 12px; border-radius: 8px; background: #fff; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
    ...
    <a v-if="explorerUrl" :href="explorerUrl" target="_blank" rel="noopener noreferrer" style="font-size: 12px; color: #666;">
      View on Explorer
    </a>
  </div>
</template>
